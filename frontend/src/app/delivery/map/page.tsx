...
// Sub-component to handle the search params logic
  ...
  return (
    <main className="pt-20 pb-24 min-h-screen max-w-5xl mx-auto px-4 sm:px-6">
      ...
      <div className="py-6 flex items-center gap-4 mb-4">
        ...
        <div className="flex-1">
          <h1 className="text-2xl font-extrabold font-headline tracking-tight text-left">
            Navigation
          </h1>
          <p className="text-on-surface-variant font-body text-sm text-left">
            Live Tracking & Route Tips
          </p>
        </div>
      </div>
